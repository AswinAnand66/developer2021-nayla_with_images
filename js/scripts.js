(function ($) {
    ...
    function naylaHeader() {
        ...
        function fullscreenNavigation() {
            ...
            if (nav.length) {
                ...
                mainMenu.append('<span class="sub-close"><span class="material-symbols-outlined">close</span></span>')
            ...
            switchList.on('click', () => {
                ...
                gsap.to(projects, {
                    ...
                    onComplete: () => {
                        ...
                        $('<span class="g-list-arrow material-symbols-outlined">arrow_outward</span>').insertBefore(projects.find('.grid-project-wrap .grid-project-meta > div:last-child'))
                ...
                naylaVid.on('ready', (event) => {
                    ...
                    if ($this.hasClass('nayla-play')) {
                        ...
                        if (play !== 'icon') {
                            ...
                            $this.append('<div class="play-icon icon"><span class="material-symbols-outlined">play_arrow</span></div>')
                        }
    ...
    function naylaCircleText() {
        ...
        circularText.each(function (i) {
            ...
            if (dataIcon) {
                ...
                $this.append("<div class='circular-text-icon'><span class='material-symbols-outlined'>" + dataIcon + "</span></div>")
            ...
            if (dataSeperator) {
                ...
                seperator.wrapInner('<span class="material-symbols-outlined">' + dataSeperator + '</span>')
    ...
    function naylaMarquee(i) {
        ...
        marquee.each(function () {
            ...
            text.append('<span class="material-symbols-outlined">' + seperator + '</span>')
    ...
    function naylaTeamMember() {
        ...
        member.each(function () {
            ...
            image.append('<div class="cv-toggle"><span class="material-symbols-outlined">add</span></div>')
